...
export default function FormProfileProfessional() {
          ...
          <Row>
            ...
            <Col md={3}>
              <Form.Group>
                ...
                <Form.Control type="text" controlId="crm" name="crm" required />
              </Form.Group>
            </Col>
          ...
          <Row>
            <Col>
              <Form.Group>
                ...
                <Form.Control name="cpf" controlId="cpf" type="text" required />
              </Form.Group>
            </Col>
